...
<div class="container-fluid">
    ...
    <a class="navbar-brand" hewd="a">Mi tienda</a>
    ...
    <div class="collapse navbar-collapse" id="navbarMavDropdown">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link" data-bs-toggle="modal" data-bs-target="modal_cart" style="color:red; cursor:pointer;"><i class="fas fa-shopping-cart"></i></a>
            </li>
        </ul>
    </div>
